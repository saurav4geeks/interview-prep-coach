...
3. Elevator System
4. Chess / Snake and Ladder (state machine)
5. Library Management System

---

## DSA Pattern Cheatsheet Reference
See `dsa-patterns.md` for concept notes per topic.

## HLD Framework Reference
See `hld-framework.md` for the step-by-step approach to use in every HLD session.
